...
setprop debug.performance.tuning 1
setprop debug.performance.tuning.touch 1
setprop debug.performance.tuning.flinger 1
setprop debug.performance.tuning.cpu 1
setprop debug.performance.tuning.gpu 1
setprop debug.performance.tuning.input 1
setprop debug.rs.max-threads true
setprop debug.rs.script 1
setprop debug.systemuicompilerfilter speed
setprop debug.choreographer.skipwarning 16500000
...
setprop debug.hwui.target_cpu_time_percent 40
...
setprop debug.hwui.high_performance_mode true
setprop debug.hwui.use_gpu_pixel_buffers true
setprop debug.hwui.use_hint_manager true
setprop debug.hwui.use_overlay_buffer true
setprop debug.hwui.skip_empty_damage true
setprop debug.hwui.use_buffer_queue true
...
dong > /dev/null 2>&1  
ff() {
cmd game set --fps $refresh_rate --mode 2 --downscale 0.1 com.dts.freefiremax
