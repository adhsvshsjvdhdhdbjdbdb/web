...
log() {
# Suppress log tags
setprop log.tag.SQLiteQueryBuilder INFO
setprop log.tag.FuseDaemon INFO
setprop log.tag.GAv4 INFO
setprop log.tag.CAM2PORT_ INFO
setprop log.tag.FragmentManager INFO
setprop log.tag.libfuse INFO
setprop log.tag.AndroidRuntime INFO
setprop log.tag.PackageManager INFO
setprop log.tag.ActivityManager INFO
setprop log.tag.WindowManager INFO
setprop log.tag.AudioManager INFO
setprop log.tag.InputMethodManager INFO
setprop log.tag.BluetoothManager INFO
setprop log.tag.NetworkManagement INFO
setprop log.tag.ConnectivityManager INFO
setprop log.tag.WifiManager INFO
setprop log.tag.TelephonyManager INFO
setprop log.tag.LocationManager INFO
setprop log.tag.SensorManager INFO
setprop log.tag.PowerManager INFO
setprop log.tag.SurfaceFlinger INFO
setprop log.tag.MediaPlayer INFO
setprop log.tag.AudioPolicyManager INFO
setprop log.tag.InputManager INFO
setprop log.tag.AccountManager INFO
setprop log.tag.DevicePolicyManager INFO
setprop log.tag.WallpaperManager INFO
setprop log.tag.BatteryManager INFO
setprop log.tag.ContentManager INFO
setprop log.tag.GraphicsStats INFO
setprop log.tag.JobScheduler INFO
setprop log.tag.UsbManager INFO
setprop log.tag.VpnManager INFO
setprop log.tag.NotificationManager INFO
setprop log.tag.AlarmManager INFO
setprop log.tag.ClipboardManager INFO
setprop log.tag.InputDispatcher INFO
setprop log.tag.NetworkStats INFO
setprop log.tag.BackupManager INFO
setprop log.tag.KeyguardManager INFO
setprop log.tag.DeviceIdleController INFO
setprop log.tag.ActivityTaskManager INFO
setprop log.tag.DisplayManager INFO
setprop log.tag.UsbHostManager INFO
setprop log.tag.AppOps INFO
setprop log.tag.HardwarePropertiesManager INFO
setprop log.tag.StorageManager INFO
setprop log.tag.ServiceManager INFO
setprop log.tag.DockObserver INFO
setprop log.tag.PersistentDataBlockManager INFO
setprop log.tag.NetworkTimeUpdateService INFO
setprop log.tag.ThermalManager INFO
setprop log.tag.PrintManager INFO
setprop log.tag.NetworkPolicy INFO
setprop log.tag.BluetoothAdapter INFO
setprop log.tag.BluetoothSocket INFO
setprop log.tag.BluetoothDevice INFO
setprop log.tag.MediaRouter INFO
setprop log.tag.MediaSession INFO
setprop log.tag.LocationProvider INFO
setprop log.tag.ConnectivityService INFO
setprop log.tag.BatteryStatsService INFO
setprop log.tag.ProcessStats INFO
setprop log.tag.PackageInstaller INFO
setprop log.tag.DownloadManager INFO
setprop log.tag.SystemServer INFO
setprop log.tag.HardwareService INFO
setprop log.tag.PowerManagerService INFO
setprop log.tag.InputMethodManagerService INFO
setprop log.tag.StatusBarManagerService INFO
setprop log.tag.NetworkManagementService INFO
setprop log.tag.NetworkPolicyManagerService INFO
setprop log.tag.TelephonyRegistry INFO
setprop log.tag.MountService INFO
setprop log.tag.WindowManagerService INFO
setprop log.tag.DisplayManagerService INFO
setprop log.tag.ActivityManagerService INFO
setprop log.tag.ActivityTaskManagerService INFO
setprop log.tag.AlarmManagerService INFO
setprop log.tag.NotificationManagerService INFO
setprop log.tag.VibratorService INFO
setprop log.tag.ConsumerIrService INFO
setprop log.tag.DevicePolicyManagerService INFO
setprop log.tag.LocationManagerService INFO
setprop log.tag.InputManagerService INFO
setprop log.tag.AudioService INFO
setprop log.tag.MediaPlayerService INFO
setprop log.tag.AudioPolicyService INFO
setprop log.tag.BluetoothService INFO
setprop log.tag.BluetoothGattService INFO
setprop log.tag.BluetoothHidService INFO
setprop log.tag.BluetoothPanService INFO
setprop log.tag.BluetoothMapService INFO
setprop log.tag.BluetoothPbapService INFO
setprop log.tag.BluetoothSapService INFO
}
log > /dev/null 2>&1  
